...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Studentcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"sokaris07.biz", "sokaris07.biz"},
    {"sokaris07.dynip.sapo.pt", "sokaris07.dynip.sapo.pt"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Studentcoin is probably already running."), addrBind.ToString().c_str());
        else
